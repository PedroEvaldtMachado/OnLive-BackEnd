...
import { RequestUserAuthentication, ResponseUserAuthentication } from 'classes/auth';

export const authConfig: NextAuthOptions = {
  providers: [
    // Primeiro somente utilizar autenticação pelo google, depois talvez ativar a própria
    // CredentialsProvider({
    //   name: "Login",
    //   credentials: {
    //     email: {
